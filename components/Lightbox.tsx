  ...
  const content = (
    ...
    >
      ...
      <div
        ref={crossLeftRef}
        id="lb-cross-l"
        className="absolute left-[20vw] top-1/2 h-[22px] w-[22px] pointer-events-none z-20 mix-blend-difference text-white"
      >
      ...
      <div
        ref={crossRightRef}
        id="lb-cross-r"
        className="absolute right-[20vw] top-1/2 h-[22px] w-[22px] pointer-events-none z-20 mix-blend-difference text-white"
      >
        <div className="absolute left-1/2 top-0 h-full w-px -translate-x-1/2 rounded-sm bg-current" />
        <div className="absolute left-0 top-1/2 h-px w-full -translate-y-1/2 rounded-sm bg-current" />
      </div>
      ...
      <div
        ref={titleRef}
        id="lightbox-title"
        className="pointer-events-none absolute left-1/2 top-1/2 z-20 whitespace-nowrap text-center font-serif font-light text-white mix-blend-difference select-none"
        style={{
      ...
      <div
        ref={labelRef}
        id="lightbox-label"
        className="pointer-events-none absolute left-1/2 z-20 font-mono text-[0.58rem] uppercase tracking-[0.3em] text-white mix-blend-difference select-none"
        style={{
      ...
      <div
        ref={counterRef}
        id="lb-counter"
        className="pointer-events-none absolute bottom-11 left-1/2 z-20 font-mono text-[0.6rem] tracking-[0.18em] text-white mix-blend-difference"
      />
    </div>
  );
